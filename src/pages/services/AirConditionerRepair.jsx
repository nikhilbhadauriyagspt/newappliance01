...
import { FaCheckCircle, FaArrowLeft, FaShieldAlt, FaTools, FaRegClock, FaArrowRight, FaClipboardList, FaSearch, FaWrench, FaMicrochip, FaWind } from 'react-icons/fa';
...
const AirConditionerRepair = () => {
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      <Helmet>
        <title>Expert AC Repair Service | Air Conditioner Fix | Appliance Vista</title>
      ...
      <section className="relative pt-44 pb-32 bg-primary overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
           ...
           <p className="text-slate-400 text-lg md:text-xl font-medium max-w-2xl leading-relaxed">
             Precision HVAC diagnostics for split and window AC systems. Restoring thermal efficiency and air quality with factory-grade components.
           </p>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 md:px-8 py-32 relative -mt-16 bg-white rounded-t-[60px] z-20">
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative group">
              ...
              <div className="relative rounded-[3rem] overflow-hidden shadow-premium">
                <img src="/service-7.jpg" className="w-full h-[600px] object-cover transition-transform duration-1000 group-hover:scale-110" alt="AC Repair" />
              ...
              <div className="absolute -bottom-10 -right-10 bg-white p-10 rounded-[40px] shadow-2xl border border-slate-50 hidden md:block max-w-xs">
                 <div className="flex flex-col gap-6">
                    <div className="flex items-center gap-4">
                       ...
                       <p className="text-primary font-black text-sm leading-tight tracking-tight uppercase">BTU Efficiency <br />Certified</p>
                    </div>
        ...
        <div className="mb-32">
           <div className="text-center max-w-3xl mx-auto mb-20">
              <h3 className="text-3xl md:text-5xl font-black text-primary mb-6 tracking-tighter uppercase">AC Restoration <span className="text-secondary">Protocol</span></h3>
              <p className="text-slate-500 font-medium">Systematic approach to climate control engineering.</p>
           </div>
           <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                { icon: <FaClipboardList />, title: "Thermal Audit", desc: "Measuring inlet/outlet air temperatures and BTU output." },
                { icon: <FaSearch />, title: "Pressure Scan", desc: "Checking refrigerant charge levels and compressor load." },
                { icon: <FaWrench />, title: "Precision Fix", desc: "Replacing capacitors, boards or cleaning coils with OEM specs." },
                { icon: <FaCheckCircle />, title: "Efficiency Test", desc: "Final energy draw verification and air quality check." }
              ].map((step, i) => (
        ...
        <div className="bg-primary rounded-[60px] p-12 md:p-24 text-white relative overflow-hidden mb-32">
           ...
           <div className="relative z-10">
              <h3 className="text-3xl md:text-5xl font-black mb-16 tracking-tighter uppercase">AC Unit <br /><span className="text-secondary">Component Integrity Check</span></h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                 {["Inverter Compressor Unit", "Condenser Coil Network", "Main Logic PCB Module", "Blower Fan Assembly", "Capacitor Array", "Expansion Valve", "Drainage Pump System", "Thermostat Sensors", "Air Filtration Grid"].map((item, i) => (
        ...
        <div className="text-center max-w-4xl mx-auto">
           ...
           <h3 className="text-3xl md:text-4xl font-black text-primary mb-6 tracking-tighter uppercase">Climate Performance Guarantee</h3>
           <p className="text-slate-500 text-lg font-medium leading-relaxed mb-10">Every AC repair includes our signature thermal efficiency warranty and OEM part assurance for ultimate summer peace of mind.</p>
           <button onClick={() => openBookingModal('Air Conditioner')} className="px-12 py-5 bg-secondary text-white rounded-2xl font-black uppercase tracking-[3px] text-xs shadow-xl hover:bg-primary transition-all">Book Summer Checkup</button>
        </div>
      </div>
    </div>
  );
