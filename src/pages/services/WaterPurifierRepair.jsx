...
import { FaCheckCircle, FaArrowLeft, FaShieldAlt, FaTools, FaRegClock, FaArrowRight, FaClipboardList, FaSearch, FaWrench, FaMicrochip, FaWater } from 'react-icons/fa';
...
const WaterPurifierRepair = () => {
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      <Helmet>
        <title>Expert Water Purifier Repair | RO & UV Service | Appliance Vista</title>
      ...
      <section className="relative pt-44 pb-32 bg-primary overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
           ...
           <p className="text-slate-400 text-lg md:text-xl font-medium max-w-2xl leading-relaxed">
             Precision diagnostics for RO, UV, and UF filtration systems. Restoring water purity and flow efficiency with factory-grade membranes and components.
           </p>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 md:px-8 py-32 relative -mt-16 bg-white rounded-t-[60px] z-20">
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative group">
              ...
              <div className="relative rounded-[3rem] overflow-hidden shadow-premium">
                <img src="/service-10.jpg" className="w-full h-[600px] object-cover transition-transform duration-1000 group-hover:scale-110" alt="Water Purifier Repair" />
              ...
              <div className="absolute -bottom-10 -right-10 bg-white p-10 rounded-[40px] shadow-2xl border border-slate-50 hidden md:block max-w-xs">
                 <div className="flex flex-col gap-6">
                    <div className="flex items-center gap-4">
                       ...
                       <p className="text-primary font-black text-sm leading-tight tracking-tight uppercase">Purity Level <br />Certified</p>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                       ...
                       <p className="text-primary font-black text-sm leading-tight tracking-tight uppercase">OEM Filter <br />Standards</p>
                    </div>
                 </div>
              </div>
            </div>
        ...
        <div className="mb-32">
           <div className="text-center max-w-3xl mx-auto mb-20">
              <h3 className="text-3xl md:text-5xl font-black text-primary mb-6 tracking-tighter uppercase">Purification <span className="text-secondary">Protocol</span></h3>
              <p className="text-slate-500 font-medium">Systematic approach to chemical and biological water safety.</p>
           </div>
           <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                { icon: <FaClipboardList />, title: "TDS Audit", desc: "Digital verification of pre and post filtration mineral levels." },
                { icon: <FaSearch />, title: "Pressure Scan", desc: "Verifying pump output and membrane resistance." },
                { icon: <FaWrench />, title: "Filter Fix", desc: "Replacing sedi/carbon units with original components." },
                { icon: <FaCheckCircle />, title: "Sterile Test", desc: "Final UV intensity and output flow verification." }
              ].map((step, i) => (
        ...
        <div className="bg-primary rounded-[60px] p-12 md:p-24 text-white relative overflow-hidden mb-32">
           ...
           <div className="relative z-10">
              <h3 className="text-3xl md:text-5xl font-black mb-16 tracking-tighter uppercase">Purifier <br /><span className="text-secondary">Subsystem Health-Check</span></h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                 {["Booster Diaphragm Pump", "RO Membrane Module", "UV Chamber Assembly", "Pre-Sediment Filter", "Activated Carbon Block", "UF Hollow Fiber Unit", "Main Control PCB", "Solenoid Water Valve", "Auto-Flush Controller"].map((item, i) => (
