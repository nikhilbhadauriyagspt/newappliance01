      ...
      <section className="relative pt-44 pb-32 bg-primary overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10 text-center">
          <div className="inline-flex items-center gap-3 bg-white/5 px-4 py-2 rounded-full mb-8 border border-white/10">
            <span className="text-secondary text-[10px] font-black uppercase tracking-[3px]">Expert help now</span>
          </div>
          <h1 className="text-5xl md:text-6xl font-black text-white mb-8 leading-tight tracking-tighter uppercase">
            Simple <br />Repair <span className="text-secondary">Solutions</span>
          </h1>
          <p className="text-slate-400 text-lg md:text-xl font-medium max-w-2xl mx-auto leading-relaxed">
            Reliable help for your home and business equipment. We make sure every repair is done right.
          </p>
        </div>
      </section>
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    ...
                    <div className="flex items-center justify-between pt-8 border-t border-slate-50">
                      <span className="text-[10px] font-black uppercase tracking-[3px] text-primary group-hover:gap-6 flex items-center gap-3 transition-all">
                        Expert Repair <FaArrowRight className="text-secondary" />
                      </span>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-8">
          <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-30">
            <span className="text-xl font-black tracking-widest italic uppercase text-primary">SAMSUNG</span>
            <span className="text-xl font-black tracking-widest uppercase text-primary">LG</span>
            <span className="text-xl font-black tracking-widest uppercase text-primary">Bosch</span>
            <span className="text-xl font-black tracking-widest uppercase text-primary">MAYTAG</span>
          </div>
        </div>
      </section>
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-16">
              <div className="text-center lg:text-left">
                <h2 className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tighter leading-none">
                  NEED <br /><span className="text-secondary">HELP NOW?</span>
                </h2>
                <div className="flex flex-wrap justify-center lg:justify-start gap-6">
                  <div className="flex items-center gap-3">
                    <FaCheckCircle className="text-secondary" />
                    <span className="text-white text-[10px] font-black uppercase tracking-widest">Fast Help</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <FaCheckCircle className="text-secondary" />
                    <span className="text-white text-[10px] font-black uppercase tracking-widest">Great Parts</span>
                  </div>
                </div>
              </div>
